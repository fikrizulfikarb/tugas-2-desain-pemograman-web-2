                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-6">
                        <div class="location_icon_bottum">
                            <ul>
                                <li><img src="{{ url('public') }}/icon/call.png" />(+71)9876543109</li>
                                <li><img src="{{ url('public') }}/icon/email.png" />demo@gmail.com</li>
                                <li><img src="{{ url('public') }}/icon/loc.png" />Location</li>
                            </ul>
                        </div>
                    </div>
                </div>
